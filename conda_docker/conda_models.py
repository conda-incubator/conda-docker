...
class Context:
    ...
    def __init__(self, subdir=None, default_channels=None, restore_free_channel=False, croot="", bld_path="", root_prefix=""):
        self._subdir = subdir
        self._default_channels = DEFAULT_CHANNELS if default_channels is None else default_channels
...
class Channel:
    ...
    def __init__(self, scheme=None, auth=None, location=None, token=None, name=None,
                 platform=None, package_filename=None, context=None):
        self.scheme = scheme
        self.auth = auth
    ...
    def urls(self, with_credentials=False, subdirs=None):
        ...
        if self.canonical_name == UNKNOWN_CHANNEL:
            return Channel(DEFAULTS_CHANNEL_NAME).urls(with_credentials=with_credentials, subdirs=subdirs)
